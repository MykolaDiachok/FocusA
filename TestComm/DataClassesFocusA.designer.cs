...
namespace TestComm
{
    ...
    partial void Inserttbl_Connection(tbl_Connection instance);
    partial void Updatetbl_Connection(tbl_Connection instance);
    partial void Deletetbl_Connection(tbl_Connection instance);
    ...
    partial void Deletetbl_Operation(tbl_Operation instance);
		...
		public DataClassesFocusADataContext() : 
				base(global::TestComm.Properties.Settings.Default.FPWorkConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<tbl_Connection> tbl_Connections
		{
			get
			{
				return this.GetTable<tbl_Connection>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tbl_Connections")]
	public partial class tbl_Connection : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDataServerIPChanging(string value);
    partial void OnDataServerIPChanged();
    ...
    partial void OnUserPasswordChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DataServerIP", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string DataServerIP
		{
			get
			{
				return this._DataServerIP;
			}
			set
			{
				if ((this._DataServerIP != value))
				{
					this.OnDataServerIPChanging(value);
					this.SendPropertyChanging();
					this._DataServerIP = value;
					this.SendPropertyChanged("DataServerIP");
					this.OnDataServerIPChanged();
				}
			}
		}
