...
namespace PrintFPService
{
    public partial class ServicePrintFP : ServiceBase
    {
        ...
        public ServicePrintFP(params string[] args)
        {
            ...
            if (!System.Diagnostics.EventLog.SourceExists("ServicePrintFP"))
            {
                System.Diagnostics.EventLog.CreateEventSource(
                    "ServicePrintFP", "ServicePrintFPLog");
            }
            eventLog1.Source = "ServicePrintFP";
            eventLog1.Log = "ServicePrintFPLog";
            this.args = args;
        }
    ...
    public class StartApp
    {
        ...
        public StartApp(params string[] args)
        {
            ...
            new OptionSet()
                ...
                .Add("cn=|compname=", cn => compname = cn)
                .Parse(args);
