...
namespace CentralLib.Protocols
{
    ...
    public class Protocol_EP11 : BaseProtocol, IProtocols
    {
        ...
        public Protocol_EP11(CentralLib.Connections.DefaultPortCom dComPort, Int64 inFPNumber):base(dComPort, inFPNumber)
        {
            useCRC16 = true;
        ...
        public Protocol_EP11(int serialPort, Int64 inFPNumber):base(serialPort, inFPNumber)
        {
            useCRC16 = true;
            MaxStringLenght = 75;
            initial();
        ...
        public Protocol_EP11(string IpAdress,int port, Int64 inFPNumber) :base(IpAdress,port, inFPNumber)
        {
            useCRC16 = true;
