...
namespace SyncOpenStore
{
    ...
    partial void Inserttbl_CashIn(tbl_CashIn instance);
    partial void Updatetbl_CashIn(tbl_CashIn instance);
    partial void Deletetbl_CashIn(tbl_CashIn instance);
    ...
    partial void Deletetbl_Cashier(tbl_Cashier instance);
		...
		public System.Data.Linq.Table<tbl_CashIn> tbl_CashIns
		{
			get
			{
				return this.GetTable<tbl_CashIn>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tbl_CashIn")]
	public partial class tbl_CashIn : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnidChanged();
    partial void OnidComInitChanging(long value);
    partial void OnidComInitChanged();
    partial void OnFPNumberChanging(int value);
    partial void OnFPNumberChanged();
    partial void OnInMoneyChanging(int value);
    partial void OnInMoneyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idComInit", DbType="BigInt NOT NULL")]
		public long idComInit
		{
			get
			{
				return this._idComInit;
			}
			set
			{
				if ((this._idComInit != value))
				{
					this.OnidComInitChanging(value);
					this.SendPropertyChanging();
					this._idComInit = value;
					this.SendPropertyChanged("idComInit");
					this.OnidComInitChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InMoney", DbType="Int NOT NULL")]
		public int InMoney
		{
			get
			{
